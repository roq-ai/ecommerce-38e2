  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to ecommerce - Your one-stop solution for seamless login, signup, cart management, product listings, categories, and filters. Simplifying online shopping like never before."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1661956602944-249bcd04b63f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHxlLWNvbW1lcmNlfGVufDB8fHx8MTY5MDE5ODI5M3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to ecommerce - Your one-stop solution for seamless login, signup, cart management, product listings, categories, and filters. Simplifying online shopping like never before.`}
            </Text>
            <Box
